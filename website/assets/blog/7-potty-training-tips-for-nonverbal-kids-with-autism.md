...
This blog draws from the [expert guidance of psychologists](https://www.autismspeaks.org/expert-opinion/seven-toilet-training-tips-help-nonverbal-kids-autism) Dr. Courtney Aponte and Dr. Daniel Mruzek from the University of Rochester Medical Center (part of the Autism Speaks Autism Treatment Network), along with additional best practices from behavioral therapy and ABA research.
...
### 1. Use Simple Language and Visual Supports — Less Is More
...
[Children with autism thrive on predictability](https://ontargetaba.com/2026/01/06/the-power-of-routine-in-aba-therapy-why-predictability-helps-children-thrive/). A structured bathroom schedule removes the mystery and anxiety from the experience by making toilet trips expected and routine.
...
Over time, patterns will emerge. You'll begin to see when your child is most likely to need to go, which allows you to schedule proactive bathroom trips and stack the odds of success in your favor. More opportunities for success = more opportunities for [reinforcement and learning](https://ontargetaba.com/2026/01/06/the-power-of-routine-in-aba-therapy-why-predictability-helps-children-thrive/).

This approach is also central to ABA (Applied Behavior Analysis) therapy and is used by [behavioral specialists](https://ontargetaba.com/2025/12/04/who-works-with-my-child-in-aba-therapy-understanding-the-aba-therapy-team/) across autism treatment settings.
...
- [**Picture card:**](https://ontargetaba.com/2025/12/22/pecs-for-autism-a-parents-guide-to-the-picture-exchange-communication-system/) Clip a small picture of a toilet to your child's clothing or keep one accessible. Teach them to hand it to you when they need to go.
...
- An [autism-trained behavioral therapist](https://ontargetaba.com/our-process/) who can conduct a functional assessment and develop a personalized training plan
