...
[**The Sibling Support Project**](https://siblingsupport.org/) — a national program dedicated to the interests of brothers and sisters of people with disabilities. Offers workshops, resources, and connection for siblings of all ages.

[**Autism Speaks Family Services**](https://www.autismspeaks.org/) — resources for autism families, including tool kits, community connections, and the Autism Response Team, available at autismspeaks.org.

[Sibling Stories](https://www.autismspeaks.org/blog/sibling-of-autism) — books and memoirs written by adult siblings of autistic people, which can be powerful both for adolescent siblings and for parents who want to understand the sibling experience more deeply.
...
[→ Contact us to learn about our family-centered approach to ABA therapy](https://ontargetaba.com/contact/)
...
[→ Read: Autism and mental health — understanding co-occurring conditions](https://ontargetaba.com/2026/04/30/autism-and-mental-health-understanding-co-occurring-conditions-and-how-to-get-support/)
...
[→ Read: The caregiver skills training program — a free resource every family should know](https://ontargetaba.com/2026/04/20/the-caregiver-skills-training-program-a-free-evidence-based-resource/)
