...
* A [Registered Behavior Technician (RBT)](https://ontargetaba.com/our-process/) who works one-on-one with your child
...
* [Natural Environment Teaching (NET):](https://www.autismspeaks.org/applied-behavior-analysis) learning through play and daily routines
...
[Starting ABA therapy is a big decision](https://ontargetaba.com/2025/08/06/what-to-expect-starting-aba-therapy/) — and a hopeful one. Every session brings your child closer to communication, confidence, and independence.
