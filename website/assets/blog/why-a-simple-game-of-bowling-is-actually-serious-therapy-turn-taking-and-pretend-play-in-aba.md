...
To a [trained behavior analyst](https://ontargetaba.com/2026/02/02/how-to-become-a-certified-rbt/), it's a carefully structured session targeting some of the most important [developmental skills a child with autism can build](https://ontargetaba.com/2025/10/23/building-social-skills-through-aba-therapy-helping-kids-connect-play-and-thrive/): turn-taking, cooperative play, frustration tolerance, joint attention, and social reciprocity.
...
Turn-taking sounds simple. For most neurotypical children, waiting for a turn develops naturally through everyday play experiences. But for many children with [autism spectrum disorder (ASD)](https://www.autismspeaks.org/what-autism), turn-taking is genuinely one of the most challenging social skills to master — and one of the most important.
...
- Collaborating physically with a peer towards a shared goal
...
**Positive Reinforcement** — Every successful turn, every moment of waiting, every cooperative pin reset is an opportunity for [reinforcement](https://ontargetaba.com/2025/10/22/the-power-of-reinforcement-how-positive-aba-strategies-motivate-real-change/). When a child waits their turn and then rolls the ball, the natural consequence (the pins falling, the cheers of peers) acts as powerful intrinsic reinforcement — supplemented by verbal praise or other preferred rewards as needed.
...
[**Data Collection**](https://ontargetaba.com/2025/11/13/why-data-matters-in-aba-therapy-turning-small-wins-into-big-results/) — Even in the middle of a bowling game, your child's RBT is observing and tracking: Did the child wait without prompting? Did they respond when their turn was cued? Did they initiate a cooperative behavior? This data informs how the program evolves.
