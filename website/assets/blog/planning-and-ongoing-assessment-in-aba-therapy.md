...
Each therapy program is carefully designed and supervised by a [Board Certified Behavior Analyst (BCBA)](https://ontargetaba.com/2025/12/04/who-works-with-my-child-in-aba-therapy-understanding-the-aba-therapy-team/) who evaluates the learner's unique abilities, needs, and preferences. Rather than using a one-size-fits-all approach, ABA therapy programs are customized for each individual and adjusted regularly based on measurable progress.
...
[ABA therapy is a data-driven approach](https://ontargetaba.com/2026/02/14/understanding-aba-data-a-parents-guide-to-tracking-progress-in-aba-therapy/), meaning that therapists collect information during every session.
...
If progress slows, the BCBA may modify the approach by:
