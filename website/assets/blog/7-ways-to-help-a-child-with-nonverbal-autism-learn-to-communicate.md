...
At [On Target ABA](https://ontargetaba.com/our-process/), we believe communication is not just about speech. It's about connection, understanding, and giving your child the tools they need to express themselves confidently — in ways that work for them.
...
### 1. Build Communication Through Play
...
### 2. Expand Your Child's Gestures and Sounds
...
When your [child makes any attempt to communicate](https://www.autismspeaks.org/expert-opinion/seven-ways-help-your-child-nonverbal-autism-speak), respond right away. This teaches them that gestures and sounds have power.
...
### 3. Use AAC Tools Early (Not as a Last Resort)
...
* [Picture Exchange Communication System (PECS)](https://ontargetaba.com/2025/12/22/pecs-for-autism-a-parents-guide-to-the-picture-exchange-communication-system/)
...
### 4. Model Language Throughout the Day
...
### 7. Work Closely With Your ABA Team
...
- Introduce AAC tools if appropriate
- Teach communication through play, routines, and natural interactions
...
[Your child already has a voice](https://ontargetaba.com/2025/12/15/break-cards-in-aba-therapy-giving-children-a-voice-when-they-need-it-most/) — even if it's not spoken yet.
