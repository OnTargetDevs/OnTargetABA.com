...
[ABA therapy](https://ontargetaba.com/our-services/) is grounded in one powerful idea: all behavior serves a purpose.
...
1. Identify the behavior. (What are we seeing?)
2. Understand the function. (Why is it happening?)
3. Create a plan. (What can replace it?)
4. Reinforce success. (How do we make the new behavior stick?)
...
From center-based therapy to our [Autism Scholarship Program](https://ontargetaba.com/center-based-aba-therapy/) (ASP) classrooms, we help children learn to:
...
At [On Target ABA](https://ontargetaba.com/contact/), we celebrate every step, every smile, and every moment of growth. Because behind every milestone is a story of patience, progress, and love.
