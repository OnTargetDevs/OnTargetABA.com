...
Imagine an ABA therapy session where the child is calling the shots. Where the child chooses the toys. Where the therapist follows their interest rather than directing them to a table. Where the activities feel like play — because they are play — and learning happens not despite that but because of it.
...
Since its original conception, PRT has received much empirical support for eliciting therapeutic gains for promoting greater use of functional social communication skills in individuals with ASD, ranging from increased self-initiated social responses to advancing collateral language acquisition following increased question-asking behavior. Increased adaptive use of language and social responses have also been linked to secondary clinical gains such as reduced [disruptive behavior](https://ontargetaba.com/2026/04/06/meltdowns-vs-tantrums-whats-the-difference-and-how-aba-can-help/) and restrictive and repetitive behaviors.
...
[PRT's naturalistic, activity-based structure](https://www.autismspeaks.org/pivotal-response-treatment-prt) means that parents can implement PRT principles throughout their daily routines — at mealtimes, during bath time, in the car, at the playground, during bedtime routines — with relatively brief training and substantial support.
...
_[→ Contact us to learn about our approach to ABA therapy](https://ontargetaba.com/contact/)_  
_[→ Read: What is Natural Environment Teaching? ABA meets real life](https://ontargetaba.com/2026/04/13/what-is-natural-environment-teaching-a-complete-guide-for-autism-families/)_  
_[→ Read: What is Discrete Trial Training? A complete guide for families](https://ontargetaba.com/2026/04/16/what-is-discrete-trial-training-dtt-a-complete-guide-for-autism-families/)_  
_[→ Read: Why the best ABA therapy feels like play](https://ontargetaba.com/2026/04/10/why-the-best-aba-therapy-feels-like-play-and-why-thats-the-point/)_  
_[→ Read: When it comes to your child's progress, we move mountains](https://ontargetaba.com/2026/05/01/when-it-comes-to-your-childs-progress-we-move-mountains/)_
