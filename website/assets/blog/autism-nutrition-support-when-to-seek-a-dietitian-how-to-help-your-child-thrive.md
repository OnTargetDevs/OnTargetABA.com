...
[Children with autism](https://ontargetaba.com/2025/10/28/aba-vs-speech-therapy-for-autism-understanding-the-difference-and-working-together/) are not automatically at risk for nutrient deficiencies — but restrictive eating patterns can increase the likelihood, especially when children avoid vegetables, proteins, or high-fiber foods.
...
A [dietitian](https://www.autismspeaks.org/blog/autism-and-nutrition-when-and-how-find-registered-dietitian) can run assessments, review your child's current intake, and determine whether supplements or safe food introductions are needed.
...
[Consistency reduces anxiety](https://ontargetaba.com/2025/12/13/autism-picky-eating-tips-a-supportive-guide-for-parents-from-on-target-aba/) and creates predictability.
...
Parents often worry they need to [overhaul their child's diet overnight](https://www.autismspeaks.org/blog/autism-and-nutrition-when-and-how-find-registered-dietitian) — but progress doesn't come from pressure. It comes from small, steady steps.
...
At [On Target ABA](https://ontargetaba.com/our-process/), we partner closely with families so they feel informed, supported, and confident. Together, we celebrate every moment — from the first time your child tolerates a new food on their plate to the exciting day they finally taste it.
