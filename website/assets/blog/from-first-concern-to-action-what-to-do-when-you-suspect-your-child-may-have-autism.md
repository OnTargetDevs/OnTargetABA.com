...
You can complete the M-CHAT-R online at [autismspeaks.org/screen-your-child](https://autismspeaks.org/screen-your-child).
...
The First Concern to Action Tool Kit guides parents on how to seek an autism evaluation for their child. It provides specific resources and tools to help guide you on the journey from your first concern to action. Download it at [autismspeaks.org/tool-kit/first-concern-action-tool-kit](https://autismspeaks.org/tool-kit/first-concern-action-tool-kit).

The First Concern to Action Roadmap is a downloadable visual guide that maps the steps from initial concern through evaluation and services. Download it at [autismspeaks.org/roadmap/first-concerns-action-roadmap](https://autismspeaks.org/roadmap/first-concerns-action-roadmap).

The M-CHAT-R Screening Tool is available free at [autismspeaks.org/screen-your-child](https://autismspeaks.org/screen-your-child).
...
At On Target ABA, we serve children ages 2–12 across Ohio and Utah. We accept most [major insurance plans and Medicaid](https://ontargetaba.com/insurance/). Our team can guide families through the process of beginning ABA therapy — from the initial intake to the first session and beyond.
...
Contact your school district's Special Education office if your child is 3 or older. [Request an evaluation under IDEA](https://ldaamerica.org/advocacy/lda-position-papers/right-to-an-evaluation-of-a-child-for-special-education-services/). Services begin before a diagnosis, not after.
...
_On Target ABA serves children ages 2–12 across Ohio and Utah with center-based, home-based, and school-based ABA therapy. We accept most major insurance plans and Medicaid and offer on-site autism evaluations._

[→ Contact us to take the first step toward evaluation and therapy](https://ontargetaba.com/contact/)
[→ Access the Autism Speaks First Concern to Action Tool Kit at autismspeaks.org](https://www.autismspeaks.org/first-concern-action)
[→ Complete the free M-CHAT-R screening at autismspeaks.org/screen-your-child](https://ontargetaba.com/2026/03/10/autism-screening-why-early-autism-screening-matters-for-your-child/)
[→ Read: Early autism screening — why it matters](https://ontargetaba.com/2026/04/23/early-autism-screening-why-it-matters-and-how-to-get-started/)
[→ Read: Does insurance cover ABA therapy? A complete guide](https://ontargetaba.com/2026/04/06/does-insurance-cover-aba-therapy-everything-ohio-and-utah-families-need-to-know/)
