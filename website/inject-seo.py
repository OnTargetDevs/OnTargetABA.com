...
ORG_LD = {
    ...
    "logo": {
        "@type": "ImageObject",
        "url": f"{SITE}/wp-content/uploads/2022/04/footerImg.png",
        "width": 500,
        "height": 175,
    },
    ...
    "sameAs": [
        ...
        "https://www.linkedin.com/company/on-target-aba",
    ],
}
...
def build_head_block(slug: str, page: dict) -> str:
    ...
    image = page.get("image", f"{SITE}/wp-content/uploads/2022/04/footerImg.png")
