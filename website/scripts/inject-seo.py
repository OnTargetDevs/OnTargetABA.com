...
SEO_PAGES = {
    ...
    "salt-lake-city.html": {
        "title": 'ABA Therapy in Salt Lake City — On Target ABA',
        "desc": 'ABA therapy and autism testing serving Salt Lake City, Sandy, West Jordan, South Jordan, Draper, and the Salt Lake Valley. Family-focused care from our Murray clinic.',
        "keywords": "",
        "crumbs": [("Home", "index.html"), ("Locations", "locations.html"), ("Salt Lake City", None)],
        "primary_type": "WebPage",
    },
    "cleveland.html": {
        "title": 'ABA Therapy in Cleveland — On Target ABA',
        "desc": 'ABA therapy and autism testing serving Greater Cleveland: Beachwood, Cleveland Heights, Pepper Pike, Lyndhurst, and more from our Mayfield Village clinic.',
        "keywords": "",
        "crumbs": [("Home", "index.html"), ("Locations", "locations.html"), ("Cleveland", None)],
        "primary_type": "WebPage",
    },
    "columbus.html": {
        "title": 'ABA Therapy in Columbus, Ohio — On Target ABA',
        "desc": 'ABA therapy and autism testing in Columbus, with two metro clinics (Gahanna + Worthington) serving Westerville, Bexley, Dublin, Upper Arlington, and beyond.',
        "keywords": "",
        "crumbs": [("Home", "index.html"), ("Locations", "locations.html"), ("Columbus", None)],
        "primary_type": "WebPage",
    },
    "insurance-aetna.html": {
        "title": 'Does Aetna Cover ABA Therapy? Yes — On Target ABA',
        "desc": 'Aetna covers ABA therapy for autism in Utah and Ohio. What is covered, prior auth, co-pay expectations, and how we verify your benefits for free.',
        "keywords": "",
        "crumbs": [("Home", "index.html"), ("Insurance", "insurance.html"), ("Aetna", None)],
        "primary_type": "WebPage",
    },
    "insurance-anthem.html": {
        "title": 'Anthem Blue Cross Coverage for ABA Therapy — On Target ABA',
        "desc": 'Anthem Blue Cross Blue Shield covers ABA therapy in Utah and Ohio. Prior auth, diagnosis codes, and how we handle the paperwork for you.',
        "keywords": "",
        "crumbs": [("Home", "index.html"), ("Insurance", "insurance.html"), ("Anthem", None)],
        "primary_type": "WebPage",
    },
    "insurance-united-healthcare.html": {
        "title": 'UnitedHealthcare ABA Therapy Coverage — On Target ABA',
        "desc": 'UnitedHealthcare and Optum cover ABA therapy for autism. What plans accept ABA, how to verify benefits, and what to expect for co-pay.',
        "keywords": "",
        "crumbs": [("Home", "index.html"), ("Insurance", "insurance.html"), ("UnitedHealthcare", None)],
        "primary_type": "WebPage",
    },
    "insurance-medicaid-utah.html": {
        "title": 'Utah Medicaid ABA Therapy: How to Qualify and Get Started — On Target ABA',
        "desc": 'Utah Medicaid and CHIP cover ABA therapy for children under 21 with an autism diagnosis. How to qualify, get evaluated, and start services.',
        "keywords": "",
        "crumbs": [("Home", "index.html"), ("Insurance", "insurance.html"), ("Utah Medicaid", None)],
        "primary_type": "WebPage",
    },
    "insurance-medicaid-ohio.html": {
        "title": 'Ohio Medicaid ABA Therapy Coverage — On Target ABA',
        "desc": 'Ohio Medicaid covers ABA therapy via the Autism Spectrum Disorder benefit. MyCare Ohio plans, MCO options, qualifying, and starting services.',
        "keywords": "",
        "crumbs": [("Home", "index.html"), ("Insurance", "insurance.html"), ("Ohio Medicaid", None)],
        "primary_type": "WebPage",
    },
    "autism-scholarship-program-ohio.html": {
        "title": 'Ohio Autism Scholarship Program: Funding ABA Therapy — On Target ABA',
        "desc": 'The Ohio Autism Scholarship Program provides up to $32,455/year per child for autism services including ABA. Eligibility, applying, and using it at On Target.',
        "keywords": "",
        "crumbs": [("Home", "index.html"), ("Insurance", "insurance.html"), ("Ohio Autism Scholarship", None)],
        "primary_type": "WebPage",
    },
    "signs-of-autism-in-toddlers.html": {
        "title": 'Early Signs of Autism in Toddlers: A Parent Guide — On Target ABA',
        "desc": 'Real red flags of autism by age (12mo, 18mo, 24mo, 36mo): joint attention, name response, language, sensory differences. What to do next.',
        "keywords": "",
        "crumbs": [("Home", "index.html"), ("Resources", None), ("Signs of Autism in Toddlers", None)],
        "primary_type": "Article",
    },
    "signs-of-autism-in-girls.html": {
        "title": 'Signs of Autism in Girls: The Often-Missed Diagnosis — On Target ABA',
        "desc": 'Girls present autism differently than boys: masking, social mimicry, intense interests. Why girls are often diagnosed late and what to watch for.',
        "keywords": "",
        "crumbs": [("Home", "index.html"), ("Resources", None), ("Signs of Autism in Girls", None)],
        "primary_type": "Article",
    },
    "late-autism-diagnosis.html": {
        "title": 'Adult and Late Autism Diagnosis: What to Know — On Target ABA',
        "desc": 'Autism diagnosis in adolescents and adults: what it looks like, the evaluation process, and what comes next after a late diagnosis.',
        "keywords": "",
        "crumbs": [("Home", "index.html"), ("Resources", None), ("Late Autism Diagnosis", None)],
        "primary_type": "Article",
    },
    "aba-vs-speech-therapy.html": {
        "title": 'ABA vs Speech Therapy: Which Does My Child Need? — On Target ABA',
        "desc": 'What ABA and speech therapy each address, when both help, and how we coordinate. A clear comparison for parents choosing services.',
        "keywords": "",
        "crumbs": [("Home", "index.html"), ("Resources", None), ("ABA vs Speech Therapy", None)],
        "primary_type": "Article",
    },
    "aba-vs-occupational-therapy.html": {
        "title": 'ABA vs Occupational Therapy: How They Work Together — On Target ABA',
        "desc": 'ABA addresses behavior and communication; OT covers sensory, motor, and daily living. Most kids benefit from both. How we coordinate.',
        "keywords": "",
        "crumbs": [("Home", "index.html"), ("Resources", None), ("ABA vs Occupational Therapy", None)],
        "primary_type": "Article",
    },
    "cost-of-autism-evaluation.html": {
        "title": 'How Much Does an Autism Evaluation Cost? — On Target ABA',
        "desc": 'Most families pay $0 through insurance. Without insurance, typical costs run $2,000-$4,000. Our process: free benefits check, no waitlist.',
        "keywords": "",
        "crumbs": [("Home", "index.html"), ("Resources", None), ("Cost of Autism Evaluation", None)],
        "primary_type": "Article",
    },
    "how-long-does-aba-therapy-take.html": {
        "title": 'How Long Does ABA Therapy Take? Hours, Months and Milestones — On Target ABA',
        "desc": 'Comprehensive vs focused ABA, weekly hours (10-40), typical duration (1-3 years), and how progress is measured. A clear timeline for parents.',
        "keywords": "",
        "crumbs": [("Home", "index.html"), ("Resources", None), ("How Long Does ABA Take", None)],
        "primary_type": "Article",
    },
    "aba-for-toddlers.html": {
        "title": 'ABA Therapy for Toddlers (Ages 0-3): Early Intervention — On Target ABA',
        "desc": 'Why early intervention matters, what 0-3 ABA looks like (play-based), and what parents see in the first 3-6 months.',
        "keywords": "",
        "crumbs": [("Home", "index.html"), ("Services", "our-services.html"), ("ABA for Toddlers", None)],
        "primary_type": "Service",
    },
    "aba-for-preschoolers.html": {
        "title": 'ABA Therapy for Preschoolers (Ages 3-5) — On Target ABA',
        "desc": 'Kindergarten readiness, social skills with peers, language development, and behavior support for preschool-age children with autism.',
        "keywords": "",
        "crumbs": [("Home", "index.html"), ("Services", "our-services.html"), ("ABA for Preschoolers", None)],
        "primary_type": "Service",
    },
    "aba-for-school-age.html": {
        "title": 'ABA Therapy for School-Age Children (Ages 6-12) — On Target ABA',
        "desc": 'After-school and summer ABA programs for school-age kids. Homework support, peer skills, IEP coordination with teachers, and behavior management.',
        "keywords": "",
        "crumbs": [("Home", "index.html"), ("Services", "our-services.html"), ("ABA for School-Age", None)],
        "primary_type": "Service",
    },
    "aba-for-teenagers.html": {
        "title": 'ABA Therapy for Teenagers and Adolescents — On Target ABA',
        "desc": 'ABA is not just for little kids. Independence, executive functioning, social communication, and transition skills for teens with autism.',
        "keywords": "",
        "crumbs": [("Home", "index.html"), ("Services", "our-services.html"), ("ABA for Teenagers", None)],
        "primary_type": "Service",
    },
    "aba-for-nonverbal-children.html": {
        "title": 'ABA Therapy for Nonspeaking Children: Communication Pathways That Work — On Target ABA',
        "desc": 'AAC devices, PECS, sign language, verbal behavior. We expand whatever communication path works for your nonspeaking child.',
        "keywords": "",
        "crumbs": [("Home", "index.html"), ("Services", "our-services.html"), ("ABA for Nonspeaking Children", None)],
        "primary_type": "Service",
    },
}
