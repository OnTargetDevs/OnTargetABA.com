...
STATIC_PAGES = [
    ...
    ("/salt-lake-city", "0.85", "monthly"),
    ("/cleveland", "0.85", "monthly"),
    ("/columbus", "0.85", "monthly"),
    ("/insurance-aetna", "0.75", "monthly"),
    ("/insurance-anthem", "0.75", "monthly"),
    ("/insurance-united-healthcare", "0.75", "monthly"),
    ("/insurance-medicaid-utah", "0.8", "monthly"),
    ("/insurance-medicaid-ohio", "0.8", "monthly"),
    ("/autism-scholarship-program-ohio", "0.7", "monthly"),
    ("/signs-of-autism-in-toddlers", "0.7", "monthly"),
    ("/signs-of-autism-in-girls", "0.7", "monthly"),
    ("/late-autism-diagnosis", "0.65", "monthly"),
    ("/aba-vs-speech-therapy", "0.7", "monthly"),
    ("/aba-vs-occupational-therapy", "0.7", "monthly"),
    ("/cost-of-autism-evaluation", "0.7", "monthly"),
    ("/how-long-does-aba-therapy-take", "0.7", "monthly"),
    ("/aba-for-toddlers", "0.8", "monthly"),
    ("/aba-for-preschoolers", "0.8", "monthly"),
    ("/aba-for-school-age", "0.8", "monthly"),
    ("/aba-for-teenagers", "0.75", "monthly"),
    ("/aba-for-nonverbal-children", "0.75", "monthly"),
]
